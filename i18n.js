...
const FTA_STRINGS = {
  ru: {
    ...
    popup_section_match: "Текущий матч",
    popup_match_empty: "Открой комнату матча CS2 на FACEIT — сводка появится здесь.",
    popup_match_map: "Карта",
    popup_match_bestmaps: "Сильные карты",
    ...
    card_side: "Сторона",
    card_onmap: "На карте",
    card_favmap: "Любимая карта",
    card_worstmap: "Слабая карта",
    card_form: "Форма (посл. {n})",
    card_history: "Последние {n} матчей",
    card_extra: "Ещё статистика",
    card_no_extra: "ADR и рейтинг недоступны в публичном FACEIT API для этого игрока.",
    card_finished_line: "Этот матч: K/D {kd} (обычно {avg})",
  ...
  en: {
    ...
    popup_section_match: "Current match",
    popup_match_empty: "Open a CS2 match room on FACEIT — the summary will show up here.",
    popup_match_map: "Map",
    popup_match_bestmaps: "Strong maps",
    ...
    popup_finished_summary: "Summary",
    ...
    card_elo: "ELO",
    card_side: "Side",
    card_onmap: "On this map",
    card_favmap: "Best map",
    card_worstmap: "Worst map",
    card_form: "Form (last {n})",
    card_history: "Last {n} matches",
    card_extra: "More stats",
    card_no_extra: "ADR and rating aren't exposed by the public FACEIT API for this player.",
    card_finished_line: "This match: K/D {kd} (usually {avg})",
