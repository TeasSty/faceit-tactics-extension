...
const FTA_STRINGS = {
  ru: {
    ...
    map_reco_keep: "Оставить",
    map_reco_neutral: "Нейтрально",
    map_reco_ban: "Бан",
    popup_section_features: "Функции",
    popup_toggle_tactic: "Тактика в чат",
    popup_toggle_summary: "Сводка по команде",
    popup_label_nickname: "Мой ник на FACEIT",
    popup_nickname_placeholder: "как в профиле, с учётом регистра",
    popup_hint_nickname: "Нужен, чтобы тактика показывалась именно у твоей карточки, а не у всех подряд — определить это по странице автоматически не всегда получается.",
  ...
  en: {
    ...
    map_reco_keep: "Keep",
    map_reco_neutral: "Neutral",
    map_reco_ban: "Ban",
    popup_section_features: "Features",
    popup_toggle_tactic: "Chat tactic",
    popup_toggle_summary: "Team summary",
    popup_label_nickname: "My FACEIT nickname",
    popup_nickname_placeholder: "exact case, as in your profile",
    popup_hint_nickname: "Needed so the tactic shows on your own card, not everyone's — auto-detecting this from the page doesn't always work.",
